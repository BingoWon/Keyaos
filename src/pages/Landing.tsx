			...
			<nav className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6">
				...
				<div className="flex items-center gap-1">
					...
					<a
						...
						className="ml-1 hidden items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-50 sm:inline-flex dark:border-white/10 dark:bg-white/5 dark:text-gray-300 dark:hover:bg-white/10"
					>
						GitHub
